            ...
            <div className="col-span-1 lg:col-span-2 text-left grid">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-16">
                    <div className="flex flex-col justify-center gap-1 lg:gap-4 mr-4 lg:mr-0">
                        ...
                        <button className='bg-amber-400 hover:bg-amber-500 rounded-md lg:px-16 py-1' onClick={() => {props.addToCart(props.product.name)}}><FontAwesomeIcon icon={faShoppingCart}></FontAwesomeIcon> Add to cart</button>
                    </div>
